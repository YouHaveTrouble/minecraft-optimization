...
* [Paper](https://github.com/PaperMC/Paper) - The second most popular server software that aims to improve performance while fixing gameplay and mechanics inconsistencies.
