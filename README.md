...
It's recommended to use the [flags.sh]([https://docs.papermc.io/paper/aikars-flags](https://flags.sh/)) startup flags generator to get the correct startup flags for your server
